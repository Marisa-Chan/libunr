...
BEGIN_PROPERTY_LINK( ASavedMove, 22 )
  ...
  LINK_NATIVE_PROPERTY( MergeCount );
  LINK_NATIVE_PROPERTY( SavedLocation );
  LINK_NATIVE_PROPERTY( SavedVelocity );
  LINK_NATIVE_PROPERTY( SavedViewRotation );
END_PROPERTY_LINK()
