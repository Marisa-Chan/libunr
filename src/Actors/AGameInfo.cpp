...
BEGIN_PROPERTY_LINK( AGameInfo, 147 )
  ...
  LINK_NATIVE_PROPERTY( PlayerViewDelay );
  LINK_NATIVE_PROPERTY( PlayerSpeechDelay );
  LINK_NATIVE_PROPERTY( PlayerTauntDelay );
  LINK_NATIVE_PROPERTY( MinFOV );
  LINK_NATIVE_PROPERTY( MaxFOV );
  LINK_NATIVE_PROPERTY( MaxNameChanges );
  LINK_NATIVE_PROPERTY( NoLockdown );
  LINK_NATIVE_PROPERTY( bLogAdminActions );
  LINK_NATIVE_PROPERTY( LoginDelaySeconds );
  LINK_NATIVE_PROPERTY( MaxLoginAttempts );
  LINK_NATIVE_PROPERTY( ActionToTake );
