...
BEGIN_PROPERTY_LINK( AZoneInfo, 82 )
  ...
  LINK_NATIVE_PROPERTY( ZonePlayerExitEvent );
  LINK_NATIVE_PROPERTY( ZonePlayerDiedEvent );
  LINK_NATIVE_PROPERTY( EntrySoundBig );
  LINK_NATIVE_PROPERTY( bTakeOverCamera );
  LINK_NATIVE_PROPERTY( MaxCameraDist );
  LINK_NATIVE_PROPERTY( SkyZoneName );
  LINK_NATIVE_PROPERTY( bFarClipZone );
  LINK_NATIVE_PROPERTY( bLokiBloodZone );
  LINK_NATIVE_PROPERTY( FogBrightness );
  LINK_NATIVE_PROPERTY( FogHue );
  LINK_NATIVE_PROPERTY( FogSaturation );
END_PROPERTY_LINK()
...
BEGIN_PROPERTY_LINK( ALevelInfo, 85 )
  ...
  LINK_NATIVE_PROPERTY( ServerMoveVersion );
  ...
  LINK_NATIVE_PROPERTY( RealCrouchInfoClass );
  ...
  LINK_NATIVE_PROPERTY( EventManager );
  LINK_NATIVE_PROPERTY( bIntro );
  LINK_NATIVE_PROPERTY( bFadeIn );
  LINK_NATIVE_PROPERTY( FadeRate );
  LINK_NATIVE_PROPERTY( CdTrackLength );
  LINK_NATIVE_PROPERTY( GameVersion );
  LINK_NATIVE_PROPERTY( BuildNumber );
END_PROPERTY_LINK()
