...
BEGIN_PROPERTY_LINK( AInventory, 84 )
  ...
  LINK_NATIVE_PROPERTY( LandSound );
  LINK_NATIVE_PROPERTY( bCanUseObjectBelt );
  LINK_NATIVE_PROPERTY( LargeIcon );
  LINK_NATIVE_PROPERTY( LargeIconWidth );
  LINK_NATIVE_PROPERTY( LargeIconHeight );
  LINK_NATIVE_PROPERTY( InvSlotsX );
  LINK_NATIVE_PROPERTY( InvSlotsY );
  LINK_NATIVE_PROPERTY( InvPosX );
  LINK_NATIVE_PROPERTY( InvPosY );
  LINK_NATIVE_PROPERTY( bInObjectBelt );
