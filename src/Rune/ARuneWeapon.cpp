...
/*========================================================================
 * ARuneWeapon.cpp - Weapon class replacement for Rune
 * 
...
IMPLEMENT_ALIASED_CLASS( ARuneWeapon, GAME_Rune );

BEGIN_PROPERTY_LINK( ARuneWeapon, 109 )
