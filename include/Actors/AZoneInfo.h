...
class LIBUNR_API AZoneInfo : public AInfo
{
...
class LIBUNR_API ULevelSummary : public UObject
{
...
class LIBUNR_API ALevelInfo : public AZoneInfo
{
...
class LIBUNR_API AWarpZoneInfo : public AZoneInfo
{
